...
const Hero = props => (
  <div className="hero" style={style} id={props.player.active ? 'hero' : 'enemy'}>
      <img className="hero-image" src={images[props.player.hero]} alt={props.player.hero} style={style} />
      <HealthMeter key={props.player.health.current} health={props.player.health} width={width} height={height} />
  </div>
)
