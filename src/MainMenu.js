...
const TopButton = (props) =>(	
	<div className='TopButton'>
		<img className='TopIcon' src={props.icon} /> 
...
const MainMenu = (props) => (
    <div>
        ...
        <div class='Content'>
        	<img className='MainOrnament' src={ornament}/>
	        <ul>
	        	<li>
	        		<button className='MenuButton' type="button" onClick={() => props.sendMessage({ type: 'PROFILE' })}> Profile</button>
	        	</li>
	        	<li>
	        		<button className='MenuButton' type="button" onClick={() => props.sendMessage({ type: 'SETTINGS' })}> Settings</button>
	        	</li>
	        	<li>
	        		<button className='MenuButton' type="button" onClick={() => props.sendMessage({ type: 'PLAY' })}> Play PvP</button>
	        	</li>
	        	<li>	
	        		<button className='MenuButton' type="button" onClick={() => props.sendMessage({ type: 'PLAY' })}> Play Story</button>
	        	</li>
	        </ul>
	     </div>
    </div>
