...
test.skip('msg ACTION received: active player put Living Water in item, it increases players health current for 1pnt.', () => {
    const msg = {
        type: 'ACTION',
        activeCard: 'key1',
        target: 'item',
...
test.skip('msg ACTION received: active player has dead water in item, it decreased players health current for 1pnt.', () => {
    const msg = {
        type: 'ACTION',
        activeCard: 'key1',
        target: 'opponent',
...
test.skip('msg ACTION received: inactive player has living water in item, it increases players health current for 1pnt.', () => {
    const msg = {
        type: 'ACTION',
        activeCard: 'key1',
        target: 'opponent',
...
test.skip('msg ACTION received: active player has dead water in item, it decreases players health current for 1pnt.', () => {
    const msg = {
        type: 'ACTION',
        activeCard: 'key1',
        target: 'itemOpponent',
...
test.skip('msg ACTION received: dead water card in opponent item is attacked, it goes to grave yard, if attack points same or greater than water card points, players health does not change.', () => {
    const msg = {
        type: 'ACTION',
        activeCard: 'key1',
        target: 'itemOpponent',
...
test.skip('msg ACTION received: inactive player has living water in item, it increases players health only if current != maximum', () => {
    const msg = {
        type: 'ACTION',
        activeCard: 'key1',
        target: 'opponent',
...
test.skip('msg ACTION received: active player attacks with russianOven, it disables 2 cards in hand of opponent for 1 turn.', () => {
    const msg = {
        type: 'ACTION',
        activeCard: 'key1',
        target: 'opponent',
...
test.skip('msg ACTION received: inactive player attacked with russianOven, 2 cards in hand of active player got disabled: true for full turn.', () => {
    const msg = {
        type: 'ACTION',
        activeCard: 'key3',
        target: 'opponent',
...
test.skip('msg ACTION received: inactive player attacked with russianOven, all cards in hand of active player got disabled: false after full turn.', () => {
    const msg = {
        type: 'ACTION',
        activeCard: 'key2',
        target: 'hero',
...
test.skip('msg ACTION received: active player attacks with  skullLantern, it moves all players cards with item type to graveyards', () => {
    const msg = {
        type: 'ACTION',
        activeCard: 'key1',
        target: 'opponent',
...
test.skip('msg ACTION received: inactive player has Magic Mirror in item, it reflects half of active player attack back.', () => {
    const msg = {
        type: 'ACTION',
        activeCard: 'key1',
        target: 'opponent',
...
test.skip('msg ACTION received: inactive player has Magic Mirror in item, it reflects half of active player attack to her shield if any.', () => {
    const msg = {
        type: 'ACTION',
        activeCard: 'key1',
        target: 'opponent',
...
test.skip('msg ACTION received: inactive player has Magic Mirror in item, it reflects half of active player attack to shield and then damage player.', () => {
    const msg = {
        type: 'ACTION',
        activeCard: 'key1',
        target: 'opponent',
...
test.skip('msg ACTION received: inactive player has Magic Mirror in item, after attack its points <=0 and card goes to graveyard.', () => {
    const msg = {
        type: 'ACTION',
        activeCard: 'key1',
        target: 'itemOpponent',
...
test.skip('msg ACTION received: active player can put Magic Mirror in item holder.', () => {
    const msg = {
        type: 'ACTION',
        activeCard: 'key10',
        target: 'item',
...
test.skip('msg ACTION received: player attack opponent with clairvoyance card and can see next 3 opponent cards', () => {
    const msg = {
        type: 'ACTION',
        activeCard: 'key10',
        target: 'opponent',
...
test.skip('msg ACTION received: after turn changes cardsShown is removed from player who has been attacked with clairvoyance card', () => {
    const msg = {
        type: 'ACTION',
        activeCard: 'key5',
        target: 'opponent',
...
test.skip('msg ACTION received: player has malachiteBox in item, when player acts then opponent is attacked by bat card', () => {
    const msg = {
        type: 'ACTION',
        activeCard: 'key10',
        target: 'opponent',
...
test.skip('msg ACTION received: player can put malachiteBox in item, opponent health is not increased', () => {
    const msg = {
        type: 'ACTION',
        activeCard: 'key1',
        target: 'item',
...
test.skip('msg ACTION received: active player attacks with turningPotion and at next act can choose any 1 card from opponent hand to act for 1 move', () => {
    const msg = {
        type: 'ACTION',
        activeCard: 'key4',
        target: 'opponent',
...
test.skip('msg ACTION received: active player attacked with turningPotion and now put 1 card from opponent hand to opponent graveyard', () => {
    const msg = {
        type: 'ACTION',
        activeCard: 'key2',
        target: 'graveyard',
...
test.skip('msg ACTION received: active player attacked with turningPotion and now attacks opponent with 1 card from opponent hand', () => {
    const msg = {
        type: 'ACTION',
        activeCard: 'key2',
        target: 'opponent',
...
// player's move counter to be increased by 1 (after 2nd act)
test.skip('msg ACTION received: active player attacked with turningPotion and now put in his/her item holder 1 card from opponent hand', () => {
    const msg = {
        type: 'ACTION',
        activeCard: 'key2',
        target: 'item',
...
test.skip('msg ACTION received: inactive player put in own item holder shield card from opponent hand, after attack against player it returns to opponent graveyard', () => {
    const msg = {
        type: 'ACTION',
        activeCard: 'key10',
        target: 'opponent',
...
test.skip('msg ACTION received: active player attacked with turningPotion and now attacks opponent item with the card from opponent hand', () => {
    const msg = {
        type: 'ACTION',
        activeCard: 'key2',
        target: 'itemOpponent',
...
test.skip('msg ACTION received: if plateMail card is at opponent item, player get 1 pnts back from attack, where opponent get health damage less for 1 pnt.', () => {
    const msg = {
        type: 'ACTION',
        activeCard: 'key10',
        target: 'opponent',
