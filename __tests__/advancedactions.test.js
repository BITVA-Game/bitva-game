...
test.only('msg ACTION received: if plateMail card is at opponent item, player get 1 pnts back from attack, where opponent get health damage less for 1 pnt.', () => {
    const msg = {
        type: 'ACTION',
        activeCard: 'key10',
        target: 'opponent',
