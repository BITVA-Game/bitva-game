...
test('msg ACTION received: inactive player has dead water in item, it decreased players health current for 1pnt next 3 moves.', () => {
    const msg = {
        type: 'ACTION',
        activeCard: 'key1',
        target: 'opponent',
            ...
            players: [
                {
                    ...
                    item: {
                        key10: {
                            id: 'deadWater', type: 'damage', category: 'item', points: 2,
                        },
                    },
                    grave: {},
                },
